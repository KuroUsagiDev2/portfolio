...
<template>
	<div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
		<ul class="space-y-2">
			...
			<MenuItem title="Experience" href="/experience">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
					<path
						stroke-linecap="round"
						stroke-linejoin="round"
		...
		<ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
			<li>
				<a target="_blank" href="https://www.linkedin.com/in/kurousagi/" class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
			...
			<li>
				<a target="_blank" href="https://github.com/KurousagiDev2"
